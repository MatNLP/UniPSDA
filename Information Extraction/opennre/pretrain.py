...
def download_ace(root_path=default_root_path):
    check_root()
    if not os.path.exists(os.path.join(root_path, 'benchmark/ace')):
        os.mkdir(os.path.join(root_path, 'benchmark/ace'))
        os.system('wget -P ' + os.path.join(root_path, 'benchmark/ace') + ' ' + root_url + 'opennre/benchmark/ace/rel2id_ace.json')
        os.system('wget -P ' + os.path.join(root_path, 'benchmark/ace') + ' ' + root_url + 'opennre/benchmark/ace/en-train.txt')
        os.system('wget -P ' + os.path.join(root_path, 'benchmark/ace') + ' ' + root_url + 'opennre/benchmark/ace/en-dev.txt')
...
def download(name, root_path=default_root_path):
    ...
    if name == 'nyt10':
        ...
        download_ace(root_path=root_path)
    elif name == 'wiki20m':
